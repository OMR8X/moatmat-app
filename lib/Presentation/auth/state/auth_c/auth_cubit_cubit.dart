...
import 'package:moatmat_app/Features/auth/domain/use_cases/sign_out_uc.dart';
import 'package:moatmat_app/Features/auth/domain/use_cases/update_user_data_uc.dart';
...
import 'package:moatmat_app/Features/purchase/domain/use_cases/get_user_purchased_uc.dart';
import 'package:moatmat_app/Features/update/domain/entites/update_info.dart';
import 'package:moatmat_app/Features/update/domain/usecases/check_update_state_uc.dart';
      ...
      value.fold(
        (l) {
          if (l is MissingUserDataFailure) {
            ...
            emit(AuthError(error: l.message));
          }
        },
        (userData) async {
          if (userData.deviceId == DeviceService().deviceId || userData.deviceId.isEmpty) {
